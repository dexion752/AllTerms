...
class QnaAnswer(models.Model):
    ...
    question = models.ForeignKey('QnaQuestion', models.DO_NOTHING)
...
class QnaAnswerVoter(models.Model):
    id = models.BigAutoField(primary_key=True)
    answer = models.ForeignKey(QnaAnswer, models.DO_NOTHING)
    user = models.ForeignKey(AuthUser, models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'qna_answer_voter'
...
class QnaQuestionVoter(models.Model):
    id = models.BigAutoField(primary_key=True)
    question = models.ForeignKey(QnaQuestion, models.DO_NOTHING)
    user = models.ForeignKey(AuthUser, models.DO_NOTHING)
